...
keys_to_index = {'artist(s)_name': 1, 'streams':8, 'in_spotify_playlists':6, 'in_apple_playlists':9 , 
...
for artist in aggregated_data.keys():
  if n != 0:
    ...
    aggregate = {'artist(s)_name': artist, 'in_spotify_playlists':0, 'in_apple_playlists':0, 'in_deezer_playlists':0, 
    'streams': 0, 'bpm': 0, 'danceability_%': 0, 'energy_%': 0 }
